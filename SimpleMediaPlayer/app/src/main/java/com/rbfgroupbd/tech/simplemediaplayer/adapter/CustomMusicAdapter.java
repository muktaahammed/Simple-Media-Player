package com.rbfgroupbd.tech.simplemediaplayer.adapter;
...
import com.rbfgroupbd.tech.simplemediaplayer.MusicLibrary;
import com.rbfgroupbd.tech.simplemediaplayer.R;
...
public class CustomMusicAdapter extends BaseAdapter {
    ...
    public CustomMusicAdapter(Context context, int layout, ArrayList<MusicLibrary> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MusicLibrary music = arrayList.get(position);
